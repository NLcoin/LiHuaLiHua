...
import com.qixiaoyi.lihualihua.LihualihuaApp;

import java.io.File;
import java.io.IOException;
import java.util.concurrent.TimeUnit;

import network.api.ActivityCenterService;
import network.api.AllareasRankService;
import network.api.AuthorRecommendedService;
import network.api.BangumiAppIndexService;
import network.api.BangumiDetailsRecommendService;
import network.api.BangumiDetailsService;
import network.api.BangumiIndexService;
import network.api.BangumiRecommendService;
import network.api.BangumiScheduleService;
import network.api.HDVideoService;
import network.api.HotSearchTagService;
import network.api.LiveAppIndexService;
import network.api.LiveUrlService;
import network.api.NewBangumiSerialService;
import network.api.OriginalRankService;
import network.api.RecommendedService;
import network.api.RegionDetailsService;
import network.api.RegionRecommendService;
import network.api.RegionTypeService;
import network.api.SeasonNewBangumiService;
import network.api.SpecialTopicInfoService;
import network.api.SpecialTopicItemService;
import network.api.SplashService;
import network.api.TopicCenterService;
import network.api.TotalStationSearchService;
import network.api.UserChaseBangumiService;
import network.api.UserCoinsVideoService;
import network.api.UserContributeVideoService;
import network.api.UserFavoritesService;
import network.api.UserInfoDetailsService;
import network.api.UserInterestQuanService;
import network.api.UserLiveRoomStatusService;
import network.api.UserPlayGameService;
import network.api.VideoCommentService;
import network.api.VideoDetailsService;
import network.api.VipGameService;
    ...
    private static void initOkHttpClient()
    {
        ...
        if (mOkHttpClient == null)
        {
            synchronized (RetrofitHelper.class)
            {
                ...
                {
                    //设置Http缓存
                    Cache cache = new Cache(new File(LihualihuaApp.getInstance()
